...
export default function Category() {
  ...
  return (
    <div className={category.mainContainer}>
      ...
      >
        <Image src="/carpetC.jpg" layout="fill" height={300} width={300} />
      ...
      <div
        ...
        className={category.container}
      >
        <Image src="/kilimC.jpg" layout="fill" height={300} width={300} />
        <p className={category.title}>kilim</p>
      </div>
      <div className={category.container}>
        <Image src="/leatherC.jpg" layout="fill" height={300} width={300} />
        <p className={category.title}>Leather</p>
      </div>
      <div className={category.container}>
        <Image src="/tableClothC.jpg" layout="fill" height={300} width={300} />
